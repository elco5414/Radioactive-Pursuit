...
public abstract class Artifact implements IArtifact {
    ...
    public static double DEFAULT_DAMAGE_ADDED_VALUE = 0.0;

    protected final String name;
    protected final double healthValue;
    protected final double strength;
    protected final double movingCost;
    protected final double damageValue;
    private final ArtifactType type;

    public Artifact(ArtifactType type, String name, double healthValue, double strength, double movingCost, double damageAddedValue) {
        this.healthValue = healthValue;
        this.type = type;
        this.name = name;
        this.strength = strength;
        this.movingCost = movingCost;
        this.damageValue = damageAddedValue;
    }

    public Artifact(ArtifactType type, String name, double healthValue) {
        this(type, name, healthValue, DEFAULT_STRENGTH, DEFAULT_MOVING_COST, DEFAULT_DAMAGE_ADDED_VALUE);
    }
