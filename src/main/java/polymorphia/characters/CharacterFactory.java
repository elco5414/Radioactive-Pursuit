...
public class CharacterFactory {
    ...
    public Character createArmoredCharacter(Character myself, IArtifact armor) {
        return new ArmoredCharacter(myself, armor);
    }

    public Character createArmedCharacter(Character myself, IArtifact weapon) {
        return new ArmedCharacter(myself,weapon);
    }
}
